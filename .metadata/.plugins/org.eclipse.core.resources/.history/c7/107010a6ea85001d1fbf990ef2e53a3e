...
void menu_led_routine(MenuItem_TypeDef* hmenuitem, LED_DIO_Handle_TypeDef* hled, const char* led_name);
...
MENU_ITEM_CONTRUCTOR(menu_ldr1, { menu_led_routine(hmenuitem, &hldr1, "LDR1"); } );
MENU_ITEM_CONTRUCTOR(menu_ldg1, { menu_led_routine(hmenuitem, &hldg1, "LDG1"); } );
MENU_ITEM_CONTRUCTOR(menu_ldb1, { menu_led_routine(hmenuitem, &hldb1, "LDB1"); } );
...
MenuItem_TypeDef* MENU_MAIN_ARRAY[] = { /* Main menu list */
  ...
  //&menu_ldr2,    /* LED Red #2: breadboard red LED (LD3EX) */
  &menu_ldg1,    /* LED Green #1: on-board green LED (LD1) */
  //&menu_ldg2,    /* LED Green #2: breadboard green LED (LD1EX) */
  &menu_ldb1,    /* LED Blue #1: on-board blue LED (LD2) */
  //&menu_ldb2,    /* LED Blue #2: breadboard blue LED (LD2EX) */
